    ...
    <div className="bg-white text-gray-900 min-h-[11in] w-[8.5in] mx-auto font-sans">
      <div className="flex">
        ...
        <div className="w-64 bg-gray-800 text-white p-8">
          ...
          {/* Contact Info */}
          <div className="mb-8">
            <h2 className="text-xs font-bold tracking-widest mb-4 text-gray-400">CONTACT</h2>
          ...
          {data.skills.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xs font-bold tracking-widest mb-4 text-gray-400">SKILLS</h2>
          ...
          {data.certificates.length > 0 && (
            <div>
              <h2 className="text-xs font-bold tracking-widest mb-4 text-gray-400">CERTIFICATES</h2>
        ...
        <div className="flex-1 p-12">
          ...
          {data.summary && (
            <div className="mb-8">
              <h2 className="text-sm font-bold tracking-widest text-gray-700 mb-3">PROFILE</h2>
