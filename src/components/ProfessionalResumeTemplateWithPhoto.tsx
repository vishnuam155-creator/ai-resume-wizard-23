...
interface ProfessionalResumeTemplateWithPhotoProps {
  data: ResumeData;
}

export const ProfessionalResumeTemplateWithPhoto = ({ data }: ProfessionalResumeTemplateWithPhotoProps) => {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-[11in] w-[8.5in] mx-auto p-12 font-serif leading-relaxed">
      {/* Header with Photo */}
      <div className="flex items-start mb-8 pb-6 border-b-2 border-gray-300">
        {/* Photo Section */}
        {data.photo && (
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            ...
            {data.contacts.location && (
              <div>{data.contacts.location}</div>
            )}
      ...
      {data.summary && (
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-800 border-b border-gray-200 pb-1">
            PROFESSIONAL SUMMARY
          </h2>
